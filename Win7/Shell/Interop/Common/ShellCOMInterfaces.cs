...
using System.Text;
using GodLesZ.Library.Win7.Shell.PropertySystem;
...
#pragma warning disable 108
	...
	interface IThumbnailCache {
		...
		[In] GodLesZ.Library.Win7.Shell.ShellNativeMethods.ThumbnailOptions flags,
		[Out] out ISharedBitmap ppvThumb,
		[Out] out GodLesZ.Library.Win7.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags,
		[Out] GodLesZ.Library.Win7.Shell.ShellNativeMethods.ThumbnailId pThumbnailID);

		void GetThumbnailByID([In] GodLesZ.Library.Win7.Shell.ShellNativeMethods.ThumbnailId thumbnailID,
		[In] uint cxyRequestedThumbSize,
		[Out] out ISharedBitmap ppvThumb,
		[Out] out GodLesZ.Library.Win7.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags);
	}
