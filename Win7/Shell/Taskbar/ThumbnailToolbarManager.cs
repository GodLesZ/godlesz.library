...
namespace GodLesZ.Library.Win7.Taskbar {
	...
	public class ThumbnailToolBarManager {
		...
		/// properties on the <see cref="T:GodLesZ.Library.Win7.Taskbar.ThumbnailToolBarButton"/>. While individual buttons cannot be added or removed, 
		/// they can be shown and hidden through <see cref="P:GodLesZ.Library.Win7.Taskbar.ThumbnailToolBarButton.Visible"/> as needed. 
