...
namespace GodLesZ.Library.Win7.Shell {
	...
	/// <summary>
	/// Provides a set of flags to be used with <see cref="GodLesZ.Library.Win7.Shell.SearchCondition"/> 
	/// to indicate the operation in <see cref="GodLesZ.Library.Win7.Shell.SearchConditionFactory"/> methods.
	/// </summary>
	...
	/// <summary>
	/// Set of flags to be used with <see cref="GodLesZ.Library.Win7.Shell.SearchConditionFactory"/>.
	/// </summary>
	public enum SearchConditionType {
		...
		/// constant value using a <see cref="GodLesZ.Library.Win7.Shell.SearchConditionOperation"/>.
		/// </summary>
		Leaf = 3,
	}
