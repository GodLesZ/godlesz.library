...
using GodLesZ.Library.Win7.Resources;
using MS.WindowsAPICodePack.Internal;

namespace GodLesZ.Library.Win7.ApplicationServices {
	/// <summary>
	...
	public static class ApplicationRestartRecoveryManager {
		...
		/// </summary>
		/// <exception cref="GodLesZ.Library.Win7.ApplicationServices.ApplicationRecoveryException">
