...
namespace GodLesZ.Library.Controls {
	...
	/// </list>
	/// </remarks>
	//[Designer("GodLesZ.Library.Controls.Design.ObjectListViewDesigner")] // Uncomment this if you are feeling brave :)
	public partial class ObjectListView : ListView, ISupportInitialize {
		...
		protected ToolTipControl cellToolTip;
		...
		/// </summary>
		[Editor("GodLesZ.Library.Controls.Design.OLVColumnCollectionEditor", "System.Drawing.Design.UITypeEditor")]
		//[Editor(typeof(GodLesZ.Library.Controls.Design.OLVColumnCollectionEditor), typeof(System.Drawing.Design.UITypeEditor))]
		...
		/// <summary>
		/// Should the selection and scroll position preserved if list objects are changed?
		/// </summary>
		[Category("ObjectListView"),
		Description("Should the selection and scroll position preserved if list objects are changed?"),
		DefaultValue(true)]
		public virtual bool PreserveSelectionOnChange {
			get { return preserveSelectionOnChange; }
			set { preserveSelectionOnChange = value; }
		}
		private bool preserveSelectionOnChange = true;
		...
		/// <returns></returns>
		virtual public IEnumerable FilterObjects(IEnumerable objects, IModelFilter aModelFilter, IListFilter aListFilter) {
			// Being cautious
		...
		protected virtual void UpdateFiltering() {
			this.BuildList(preserveSelectionOnChange);
		}
		...
		public virtual void SetObjects(IEnumerable collection) {
			this.SetObjects(collection, preserveSelectionOnChange);
		}
